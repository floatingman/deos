...
(define-skeleton deos/org-header
  ...
  "#+SETUPFILE: ~/deos/setupfiles/default.setup
...
#+BEGIN_SRC emacs-lisp
(defun deos/narrow-or-widen-dwim (p)
...
(global-set-key (kbd "C-x C-n") #'deos/narrow-or-widen-dwim)
#+END_SRC
...
(defun deos/surround-scpaste (fun &rest args)
...
(advice-add 'scpaste :around #'deos/surround-scpaste)
#+END_SRC
