...
Here is a list of the bindings I'm trying out
...
(use-package helm-config
  ...
  ;; Use popwin for helm buffers, ortherwise I can't get helm to display the way
...
(use-package helm-swoop
  ...
  (setq helm-multi-swoop-edit-save t
        ...
        ;; don'd auto select the thing at point
