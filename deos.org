...
#+BEGIN_SRC sh :tangle initialize.sh
  ...
  mkdir -p ~/.emacs.d/desktops/default
  mkdir -p ~/.emacs.d/org-gcal/
#+END_SRC
...
#+BEGIN_SRC sh :tangle install.sh :eval no
    ...
    cp -vf bin/* ~/bin
    cp -vf org.png ~/.emacs.d/org-gcal/
...
#+BEGIN_SRC emacs-lisp
  ...
  (when (boundp 'package-pinned-packages)
    ...
    (try-load 'init-helpers)
    (try-load 'init-coding)
    (try-load 'init-javascript)
    (try-load 'init-org)
    (try-load 'init-gtd)
